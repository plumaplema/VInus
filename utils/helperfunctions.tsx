    ...
    if (betCompilations.length > 1) {
        if (betCompilations[1].length > 1) {
            ...
            if (lengthOfLastColumn !== 1) {
                ...
                console.log({ beforeColumn, upbeforeColumn })
                ...
                console.log('checking the second and third ', { 1: betCompilations[indexOfLastColumn - 1], 2: betCompilations[indexOfLastColumn - 2] })
